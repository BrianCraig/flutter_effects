...
mat4 mat4x3c(vec3 x, vec3 y, vec3 z, vec3 w) {
    return mat4(x.x, x.y, x.z, 0.0, y.x, y.y, y.z, 0.0, z.x, z.y, z.z, 0.0, w.x, w.y, w.z, 1.0);
}
...
vec4 openSimplex2SDerivativesPart(vec3 X) {
    ...
    vec4 derivative = -8.0 * mat4x3c(d1, d2, d3, d4) * (aa * a * extrapolations) + mat4x3c(g1, g2, g3, g4) * aaaa;
